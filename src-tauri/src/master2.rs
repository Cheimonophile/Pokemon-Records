...
pub fn run() {
    ...
    let species_palpitoad =
        create_species(conn, "Palpitoad", "", &536, &5, "Water", Some("Ground"));
    ...
    let species_seismitoad =
        create_species(conn, "Seismitoad", "", &537, &5, "Water", Some("Ground"));
