...
battle = make_battle(playthrough, pinwheel_forest,
    "Wild Tympole")
tympole = catch(playthrough,
    slot=3,
    species="Tympole",
    dex_no=535,
    type1="Water",
    caught_location=pinwheel_forest,
...
battle = make_battle(playthrough, dragonspiral_tower,
    "Wild Mienfoo")
mienfoo = catch(playthrough,
    slot=5,
    species="Mienfoo",
    dex_no=619,
    type1="Fighting",
    caught_location=dragonspiral_tower,
...
battle = make_battle(playthrough, route_9,
    "Wild Pawniard")
pawniard = catch(playthrough,
    slot=6,
    species="Pawniard",
    dex_no=624,
    type1="Dark",
    type2="Steel",
    caught_location=route_9,
